...
<main class="w-full h-full flex flex-col justify-center items-center">
    <MainCard title="Balance" class="mt-20 bg-chart bg-right-bottom bg-no-repeat">
        ...
        <svelte:fragment slot="subtitle">
            <NumberDisplay targetNumber={2589} suffix="Points" class="ml-4 subtitle"/>
        </svelte:fragment>
    </MainCard>

    <!-- <MainCard class="mt-8" aosDelay="800">
        <div class="mt-4 ml-6">
